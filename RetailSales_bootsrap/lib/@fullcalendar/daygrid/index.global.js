...
FullCalendar.DayGrid = (function (exports, core, internal$1, preact) {
  ...
  class TableListItemEvent extends internal$1.BaseComponent {
    render() {
      ...
      return (preact.createElement(internal$1.EventContainer, Object.assign({}, props, {
        elTag: "a",
      ...
      return (preact.createElement(internal$1.MoreLinkContainer, {
        ...
        popoverContent: () => {
          ...
          return (preact.createElement(preact.Fragment, null, allSegs.map((seg) => {
            ...
            }, hasListItemDisplay(seg) ? (preact.createElement(TableListItemEvent, Object.assign({
              seg: seg,
              isDragging: false,
              isSelected: instanceId === props.eventSelection,
              defaultDisplayEventEnd: false
            }, internal$1.getSegMeta(seg, props.todayRange)))) : (preact.createElement(TableBlockEvent, Object.assign({
              seg: seg,
              isDragging: false,
              isResizing: false,
              isDateSelecting: false,
  ...
  class TableCell extends internal$1.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.DayCellContainer, {
        ...
        props.showWeekNumber && (preact.createElement(internal$1.WeekNumberContainer, {
          elTag: "a",
        ...
        (props.showDayNumber || internal$1.hasCustomDayCellContent(options) || props.forceDayTop) ? (preact.createElement("div", {className: "fc-daygrid-day-top"},
          preact.createElement(InnerContent, {
            ...
            elAttrs: Object.assign(Object.assign({}, internal$1.buildNavLinkAttrs(context, date)), {id: state.dayNumberId})
          }))) : props.showDayNumber ? (
  ...
  class TableRow extends internal$1.DateComponent {
    ...
    render() {
      ...
      let {
        ...
        moreCnts,
        moreMarginTops
      } = computeFgSegPlacement(internal$1.sortEventSegs(props.fgEventSegs, options.eventOrder), props.dayMaxEvents, props.dayMaxEventRows, options.eventOrderStrict, state.eventInstanceHeights, state.maxContentHeight, props.cells);
      ...
      if (framePositions) {
        for (let placement of segPlacements) {
          ...
          */
          ...
          }, internal$1.getSegMeta(seg, todayRange)))) : (preact.createElement(TableBlockEvent, Object.assign({
            seg: seg,
            isDragging: isDragging,
  ...
  class TableRows extends internal$1.DateComponent {
    ...
    render() {
      ...
      let cellMinHeight = (rowCnt >= 7 && props.clientWidth) ?
        ...
        null;
      return (preact.createElement(internal$1.NowTimer, {unit: "day"}, (nowDate, todayRange) => (preact.createElement(preact.Fragment, null, props.cells.map((cells, row) => (preact.createElement(TableRow, {
  ...
  class DayTable extends internal$1.DateComponent {
    ...
    render() {
      let {props, context} = this;
      return (preact.createElement(Table, Object.assign({ref: this.tableRef}, this.slicer.sliceProps(props, props.dateProfile, props.nextDayThreshold, context, props.dayTableModel), {
        dateProfile: props.dateProfile,
  ...
  class DayTableView extends TableView {
    ...
    render() {
      ...
      let headerContent = options.dayHeaders && (preact.createElement(internal$1.DayHeader, {
        ref: this.headerRef,
        dateProfile: props.dateProfile,
