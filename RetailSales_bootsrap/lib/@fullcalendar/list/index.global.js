...
FullCalendar.List = (function (exports, core, internal$1, preact) {
  ...
  class ListViewHeaderRow extends internal$1.BaseComponent {
    ...
    render() {
      ...
      let renderProps = Object.assign({
        ...
        sideNavLinkAttrs: internal$1.buildNavLinkAttrs(this.context, dayDate, 'day', false)
      }, dayMeta);
  ...
  function renderInnerContent(props) {
    return (preact.createElement(preact.Fragment, null,
      props.text && (preact.createElement("a", Object.assign({
        id: props.textId,
        className: "fc-list-day-text"
      }, props.navLinkAttrs), props.text)),
      props.sideText && ( /* not keyboard tabbable */preact.createElement("a", Object.assign({
        "aria-hidden": true,
  ...
  class ListViewEventRow extends internal$1.BaseComponent {
    render() {
      ...
      }), (InnerContent, eventContentArg) => (preact.createElement(preact.Fragment, null,
  ...
  */
  class ListView extends internal$1.DateComponent {
    ...
    renderEmptyMessage() {
      ...
      }, (InnerContent) => (preact.createElement(InnerContent, {elTag: "div", elClasses: ['fc-list-empty-cushion']}))));
    }
