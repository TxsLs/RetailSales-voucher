                ...
                preact.createElement("div", {className: "fc-timegrid-now-indicator-container"},
                  preact.createElement(internal$1.NowTimer, {unit: isNowIndicator ? 'minute' : 'day' /* hacky */}, (nowDate) => {
                    ...
                    if (typeof nowIndicatorTop === 'number') {
                      return (preact.createElement(internal$1.NowIndicatorContainer, {
  ...
  */
  ...
  class TimeCol extends internal$1.BaseComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.DayCellContainer, {
        ...
        internal$1.hasCustomDayCellContent(options) && (preact.createElement(InnerContent, {
          elTag: "div",
    ...
    renderHiddenGroups(hiddenGroups, segs) {
      ...
      return (preact.createElement(preact.Fragment, null, hiddenGroups.map((hiddenGroup) => {
        ...
        return (preact.createElement(TimeColMoreLink, {
          key: internal$1.buildIsoString(internal$1.computeEarliestSegStart(hiddenSegs)),
            ...
            preact.createElement("tr", {role: "row"},
              props.axis && (preact.createElement("td", {
                ...
                preact.createElement("div", {className: "fc-timegrid-col-frame"},
                  preact.createElement("div", {className: "fc-timegrid-now-indicator-container"}, typeof nowIndicatorTop === 'number' && (preact.createElement(internal$1.NowIndicatorContainer, {
                    elClasses: ['fc-timegrid-now-indicator-arrow'],
                    elStyle: {top: nowIndicatorTop},
                    isAxis: true,
                    date: props.nowDate
                  })))))),
              props.cells.map((cell, i) => (preact.createElement(TimeCol, {
                key: cell.key,
  ...
  class DayTimeCols extends internal$1.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.NowTimer, {unit: nowIndicator ? 'minute' : 'day'}, (nowDate, todayRange) => (preact.createElement(TimeCols, Object.assign({ref: this.timeColsRef}, this.slicer.sliceProps(props, dateProfile, null, context, dayRanges), {
        forPrint: props.forPrint,
        axis: props.axis,
        dateProfile: dateProfile,
        slatMetas: props.slatMetas,
  ...
  class DayTimeColsView extends TimeColsView {
    ...
    render() {
      ...
      let allDayContent = (options.allDaySlot !== false) && ((contentArg) => (preact.createElement(internal$2.DayTable, Object.assign({}, splitProps.allDay, {
        dateProfile: dateProfile,
      ...
      let timeGridContent = (contentArg) => (preact.createElement(DayTimeCols, Object.assign({}, splitProps.timed, {
        dayTableModel: dayTableModel,
        dateProfile: dateProfile,
