...
public interface MetaDao<T extends Vo<Long>> {
    ...
    int _delete(@Param("entityType") Class<T> entityType, @Param("id") long id);

    @DeleteProvider(type = MybatisSQLProvider.class, method = "deleteMore")
    int _deleteMore(@Param("entityType") Class<T> entityType, @Param("ids") Iterable<Long> ids);

    @DeleteProvider(type = MybatisSQLProvider.class, method = "deleteAll")
    long _deleteAll(@Param("entityType") Class<T> entityType, @Param("where") Predicate where);

    @SelectProvider(type = MybatisSQLProvider.class, method = "count")
    long _count(@Param("entityType") Class<T> entityType, @Param("where") Predicate where);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findOne")
    T _findOne(@Param("entityType") Class<T> entityType, @Param("id") long id,
               @Param("excluded") String... excluded);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findMore")
    List<T> _findMore(@Param("entityType") Class<T> entityType, @Param("ids") Iterable<Long> ids,
                      @Param("excluded") String... excluded);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findAll")
    List<T> _findAll(@Param("entityType") Class<T> entityType, @Param("where") Predicate where,
                     @Param("sort") Sort sort, @Param("excluded") String... excluded);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findAll")
    Page<T> _findPage(@Param("entityType") Class<T> entityType, @Param("where") Predicate where,
                      @Param("sort") Sort sort, @Param("excluded") String... excluded);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findByName")
    T _findByName(@Param("entityType") Class<T> entityType, @Param("name") String name,
                  @Param("value") Object value, @Param("excluded") String... excluded);

    @SelectProvider(type = MybatisSQLProvider.class, method = "findAllByName")
    List<T> _findAllByName(@Param("entityType") Class<T> entityType, @Param("name") String name,
    ...
    boolean _exist(@Param("entityType") Class<T> entityType, @Param("id") long id);

    @SelectProvider(type = MybatisSQLProvider.class, method = "existsByName")
    boolean _existByName(@Param("entityType") Class<T> entityType, @Param("name") String name,
                         @Param("value") Object value, @Param("ignoreId") Long ignoreId);

    @SelectProvider(type = MybatisSQLProvider.class, method = "existsByWhere")
    boolean _existByWhere(@Param("entityType") Class<T> entityType, @Param("where") Predicate where);

    @InsertProvider(type = MybatisSQLProvider.class, method = "insert")
    int _insert(@Param("entity") T entity, @Param("ignoreNullValue") boolean ignoreNullValue,
                @Param("excluded") String... excluded);

    @UpdateProvider(type = MybatisSQLProvider.class, method = "update")
    int _update(@Param("entity") T entity, @Param("ignoreNullValue") boolean ignoreNullValue,
    ...
    int _updateSpecific(@Param("entityType") Class<T> entityType, @Param("voMap") Map<String, Object> voMap,
